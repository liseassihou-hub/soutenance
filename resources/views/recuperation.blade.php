...
<div class="recuperation-page">
    ...
    <div class="suivi-container">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-green-600 text-sm mt-1">Récuperation du code oublié</p> 
        </div>
        ...
        <form method="POST" action="{{ route('recuperation.rechercher') }}" id="recuperation-form">
            @csrf

            <div class="mb-4">
                <label for="piece_identite_numero" class="block text-gray-700 text-sm font-bold mb-2">
                    Numéro de pièce d'identité
                </label>
                <input
                    type="text"
                    id="piece_identite_numero"
                    name="piece_identite_numero"
                    value="{{ old('piece_identite_numero') }}"
        ...
        <div class="text-center mt-5">
            <a href="{{ route('suivi-demande') }}" class="text-green-600 hover:text-green-800 text-sm font-medium transition duration-200">
                <i class="fas fa-arrow-left mr-1"></i>
                     Rechercher ma demande
            </a>
        </div>

<!-- Fenêtre popup pour le code de dossier récupéré -->
